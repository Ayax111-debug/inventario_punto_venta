                        ...
                        {data.map((cat) => (
                            <tr key={cat.id} className="hover:bg-gray-50 transition-colors">
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <EditButton className='bg-blue-400 text-white hover:bg-blue-200 m-1 border border-blue-500' onClick={() => onEdit(cat)}/>
                                    <DeleteButton className='bg-red-400 text-white hover:bg-red-200 border border-red-500' onClick={() => cat.id && onDelete(cat.id)} />
                                </td>
                            </tr>
                        ))}
                    </tbody>
